...
Helm 2
```bash
$ helm install --name my-splunk-logging -f my_values.yaml https://github.com/splunk/splunk-connect-for-kubernetes/releases/download/1.4.4/splunk-kubernetes-logging-1.4.4.tgz
```

Helm 3
```bash
$ helm install my-splunk-logging -f my_values.yaml https://github.com/splunk/splunk-connect-for-kubernetes/releases/download/1.4.4/splunk-kubernetes-logging-1.4.4.tgz
```
## Uninstall ##
